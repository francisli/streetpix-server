...
describe('/api/meetings', () => {
  ...
  describe('GET /', () => {
    it('returns a list of Meetings', async () => {
      const response = await testSession.get('/api/meetings').set('Accept', 'application/json').expect(StatusCodes.OK);
    ...
    it('filters by year', async () => {
      const response = await testSession.get('/api/meetings?year=2021').set('Accept', 'application/json').expect(StatusCodes.OK);
